...
@Component({
  selector: 'app-pl-matchwise',
  templateUrl: './pl-matchwise.component.html',
  styleUrls: ['./pl-matchwise.component.scss']
})
export class PlMatchwiseComponent implements AfterViewInit,OnDestroy,OnInit {
  ...
  matchwisePl(data){
    if(this.user_id == undefined){
      ...
      // let b = 'http://192.168.0.8:4100/' + 'plMarketwise/' + data.match_id + '/'+ data.match_name + '/'+ this.type_id + '/' + this.sport_id;
      let b = a[0] + 'plMarketwise/' + data.match_id + '/'+ data.match_name + '/'+ this.type_id + '/' + this.sport_id + '/'+ this.from_date + '/'+ this.to_date;
      window.open(b, '_blank', 'location=yes,height=570,width=520,scrollbars=yes,status=yes');
    } else {
      let a = this.Base_Url.split('api/v1/');
      // let b = 'http://192.168.0.8:4100/' + 'plMarketwise/' + data.match_id + '/'+ data.match_name + '/'+ this.type_id + '/' + this.user_id+ '/' + this.sport_id;
      let b = a[0] + 'plMarketwise/' + data.match_id + '/'+ data.match_name + '/'+ this.type_id + '/' + this.user_id + '/' + this.sport_id + '/'+ this.from_date + '/'+ this.to_date;
      window.open(b, '_blank', 'location=yes,height=570,width=520,scrollbars=yes,status=yes');
    }
